...
import { setNotifications } from "../globalSlice";
import { useDispatch, useSelector } from "react-redux";
import { useEffect } from "react";
import { getNotifications } from "../utils/helper";
...
const NotificationsPage = () => {
  ...
  const notificationMarkAsRead = async (id) => {
    try {
      const readRes = await axiosInstance.put(`/notifications/${id}/read`);
  ...
  const deleteNotification = async (id) => {
    try {
      const deleteRes = await axiosInstance.delete(`/notifications/${id}`);
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex gap-2">
                        {!notification.read && (
                          <button
                            onClick={() =>
                              notificationMarkAsRead(notification._id)
                            }
