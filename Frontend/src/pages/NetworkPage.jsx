...
import { getConnectionRequests } from "../utils/helper";
...
const NetworkPage = () => {
  ...
  const getConnections = async () => {
    try {
      const conRes = await axiosInstance.get("/connections");
      setConnections(conRes?.data);
    } catch (error) {
      console.log(`Error fetching getConnections: ${error}`);
    }
  };
  console.log(connectionRequests, "connectionRes");

  useEffect(() => {
    getConnectionRequests(dispatch);
    getConnections();
  }, []);
