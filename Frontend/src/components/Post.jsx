...
const Post = ({ post }) => {
  ...
  const deletePost = async () => {
    try {
      const deletePostRes = await axiosInstance.delete(
        `/posts/delete/${post._id}`,
      );
      getPosts(dispatch);
      toast.success(deletePostRes.message || "Post deleted successfully");
    } catch (error) {
  ...
  const createComment = async () => {
    try {
      const createCommentRes = await axiosInstance.post(
